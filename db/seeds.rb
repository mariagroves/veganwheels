...
restaurant1 = Restaurant.create(
    ...
    city: "Glasgow",
    postcode: "G1 5RB",
    monday_opens_at: Time.utc(2000, 1, 1, 08, 00),
    monday_closes_at: Time.utc(2000, 1, 1, 22, 00), 
    tuesday_opens_at: Time.utc(2000, 1, 1, 08, 00), 
    tuesday_closes_at: Time.utc(2000, 1, 1, 22, 00),
    wednesday_opens_at: Time.utc(2000, 1, 1, 08, 00), 
    wednesday_closes_at: Time.utc(2000, 1, 1, 22, 00), 
    thursday_opens_at: Time.utc(2000, 1, 1, 08, 00), 
    thursday_closes_at: Time.utc(2000, 1, 1, 22, 00), 
    friday_opens_at: Time.utc(2000, 1, 1, 08, 00), 
    friday_closes_at: Time.utc(2000, 1, 1, 22, 00),
    saturday_opens_at: Time.utc(2000, 1, 1, 08, 00), 
    saturday_closes_at: Time.utc(2000, 1, 1, 22, 00), 
    sunday_opens_at: Time.utc(2000, 1, 1, 08, 00),
