...
Business.create(delivery_price: 350)
...
restaurant1 = Restaurant.create(
    ...
    city: "Glasgow",
    postcode: "G1 5RB",
    monday_opens_at: Time.new("2000/01/01 10:00"), 
    monday_closes_at: Time.new("2000/01/01 17:00"), 
    tuesday_opens_at: Time.new("2000/01/01 10:00"), 
    tuesday_closes_at: Time.new("2000/01/01 17:00"),
    wednesday_opens_at: Time.new("2000/01/01 10:00"), 
    wednesday_closes_at: Time.new("2000/01/01 17:00"), 
    thursday_opens_at: Time.new("2000/01/01 10:00"), 
    thursday_closes_at: Time.new("2000/01/01 17:00"), 
    friday_opens_at: Time.new("2000/01/01 10:00"), 
    friday_closes_at: Time.new("2000/01/01 17:00"),
    saturday_opens_at: Time.new("2000/01/01 11:00"), 
    saturday_closes_at: Time.new("2000/01/01 20:00"), 
    sunday_opens_at: Time.new("2000/01/01 00:00"),
    sunday_closes_at: Time.new("2000/01/01 00:00"),
