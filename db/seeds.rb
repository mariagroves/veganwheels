...
restaurant1 = Restaurant.create(
    ...
    monday_closes_at: Time.utc(2000, 1, 1, 17, 00), 
    tuesday_opens_at: Time.utc(2000, 1, 1, 10, 00), 
    tuesday_closes_at: Time.utc(2000, 1, 1, 17, 00),
    wednesday_opens_at: Time.utc(2000, 1, 1, 10, 00), 
    wednesday_closes_at: Time.utc(2000, 1, 1, 17, 00), 
    thursday_opens_at: Time.utc(2000, 1, 1, 10, 00), 
    thursday_closes_at: Time.utc(2000, 1, 1, 17, 00), 
    friday_opens_at: Time.utc(2000, 1, 1, 10, 00), 
    friday_closes_at: Time.utc(2000, 1, 1, 17, 00),
    saturday_opens_at: Time.utc(2000, 1, 1, 11, 00), 
    saturday_closes_at: Time.utc(2000, 1, 1, 20, 00), 
